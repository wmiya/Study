  ...
  Vidbg.prototype.init = function() {
    ...
    if ($(window).width()>2200){
    	$video.css({
	      ...
	      top: position.y,
	      left: '60%',
	      '-webkit-transform': 'scale(1.2) translate(-' + position.x + ', -' + position.y + ')',
	      '-ms-transform': 'scale(1.2) translate(-' + position.x + ', -' + position.y + ')',
	      '-moz-transform': 'scale(1.2) translate(-' + position.x + ', -' + position.y + ')',
	      transform: 'scale(1.2) translate(-' + position.x + ', -' + position.y + ')',
    ...
    $video.one('canplaythrough.' + PLUGIN_NAME, function() {
      vidbg.resize();
    })
