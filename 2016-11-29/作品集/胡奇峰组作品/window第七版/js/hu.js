(function(){
	...
	var musicText = document.getElementById('zy_music');
	...
	musicText.ondblclick = function(ev){
		wrap.style.display = 'block';
		wrap.style.width = wrap.style.height = '0px';
		wrap.style.left = '200px';
		wrap.style.top = '50px';
		mTween(wrap,{height:550,width:230,opacity:100},300,'easeOut')
