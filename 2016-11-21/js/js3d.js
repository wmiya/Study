...
//-------------生成结构----------------------------------	
	...
	pre.style.left = list.offsetLeft - 150 + 'px';
	next.style.right = (list.offsetLeft - 150) + 'px';
	for (var i = 0; i < 20; i++) {
...
//--------------------函数-------------------------------
	...
	function fn(el,disX,disY) {
		...
		switch (nub%5){
			case 0:
				break;
			case 3:a = 1,tran = 140,rota=380;
				break;
			case 2:a = 1,tran = 1350,rota=380;
				break;
			case 4:a = delay,tran =40,rota=380;
				break;
			case 1:a = Math.abs(el.cells-2),tran =40,rota=380;
				break;
			default:
				break;
		}
