		...
		circleNav.prototype.lanNav = function(){
			if(this.onOff){
				...
				for(var i = 0; i<this.setting.sBtn.length; i++){
					...
					this.setting.sBtn[i].style.transform = 'translateX(-50%) translateY(-50%) rotate(-720deg)';
				}
				...
				for(var i = 0; i<this.setting.sBtn.length; i++){
					...
					this.setting.sBtn[i].style.transform = 'translateX(-50%) translateY(-50%) rotate(0deg)';
