//tealium universal tag - utag.114 ut4.0.201606031845, Copyright 2016 Tealium.com Inc. All Rights Reserved.
...
u.map={};u.extend=[];u.send=function(a,b){if(u.ev[a]||u.ev.all!==undefined){var c,d,e,f;u.data={"base_url":"//c1.rfihub.net/js/tc.min.js","ver":"9","rb":"27079","actionid":"20740861","actionid_conv":"","ca":"","cat":"","t":"","q":b["dom.query_string"],"pid":[],"pq":[],"price":[]};c=[];for(d in utag.loader.GV(u.map)){if(b[d]!==undefined&&b[d]!==""){e=u.map[d].split(",");for(f=0;f<e.length;f++){if(u.known_args[e[f]]){u.data[e[f]]=b[d];}else{u.data[e[f]]=b[d];_rfi("setArgs",e[f],b[d]+"");}}}}
...
_rfi("track");if(!u.scriptrequested){u.scriptrequested=true;u.loader({"type":"script","src":u.data.base_url,"loc":"script","id":"utag_114"});}
}};utag.o[loader].loader.LOAD(id);}("114","usps.main"));}catch(error){utag.DB(error);}
