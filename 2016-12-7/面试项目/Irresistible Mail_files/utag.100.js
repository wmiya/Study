//tealium universal tag - utag.100 ut4.0.201606130627, Copyright 2016 Tealium.com Inc. All Rights Reserved.
var _oiqq=_oiqq||[];var _oiq_lifecycle;var oiq_doctitle;try{(function(id,loader){var u={};utag.o[loader].sender[id]=u;u.ev={"view":1};u.map={"oiq_lifecycle":"pagelifecycle"};u.extend=[function(a,b){try{if(b['dom.url'].toString().toLowerCase().indexOf('campaignId=PreHolidayShipping'.toLowerCase())>-1){b['oiq_lifecycle']='inte'}}catch(e){utag.DB(e)}}];u.send=function(a,b){if(u.ev[a]||u.ev.all!==undefined){var c,d,e,f;u.data={"tagtype":"analytics","pcode":"gfddom","pagelifecycle":"inte","order_id":"","order_subtotal":"","order_tax":"","customer_id":"","product_id":[],"product_name":[],"product_sku":[],"product_brand":[],"product_category":[],"product_quantity":[],"product_unit_price":[]};for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};c=[];for(d in utag.loader.GV(u.map)){if(b[d]!==undefined&&b[d]!==""){e=u.map[d].split(",");for(f=0;f<e.length;f++){u.data[e[f]]=b[d];}}}
...
var oiq_conv=document.createElement("script");oiq_conv.type="text/javascript";oiq_conv.async=true;oiq_conv.src=document.location.protocol+"//px.owneriq.net/j?pt="+u.data.pcode+"&s="+_oiq_lifecycle+"&sConvTitle="+oiq_doctitle+"&cnv=true";s.parentNode.insertBefore(oiq_conv,s);}})();}};utag.o[loader].loader.LOAD(id);}("100","usps.main"));}catch(error){utag.DB(error);}
